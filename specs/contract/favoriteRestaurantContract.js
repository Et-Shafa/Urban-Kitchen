...
const itActsAsFavoriteRestaurantModel = (favoriteRestaurant) => {
  ...
  //   favoriteRestaurant.putRestaurant({ id: 3, name: "restaurant c a" });
  //   favoriteRestaurant.putRestaurant({ id: 4, name: "restaurant a b c" });
  //   expect(await favoriteRestaurant.searchRestaurant("restaurant a")).toEqual([
  //     { id: 1, name: "restaurant a" },
  //     // { id: 2, name: "restaurant b" },
  //     { id: 3, name: "restaurant c a" },
  //     { id: 4, name: "restaurant a b c" },
  //   ]);
  // });
};
